...
<!--        <button id="logIn" >Log In / Register</button>-->
            <form action="log-in.php">
                <input type="submit" value="Log in / Sing Up">
            </form>
        </div>
        ...
        <div class="presentation">
            ...
            <hr>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium ad, alias commodi dolores error eum
                eveniet fugit impedit ipsam laborum minus modi natus omnis quisquam quo, ratione similique vel vero.</p>
        </div>
        ...
        <div class="travel-safe">
            <div class="travel-title">
                <h2>Travel Safe durin COVID-19</h2>
            </div>
            <div class="container-travel">
                <div class="cnt-col1">
                    <p class="sub-title">Keep yourself and others safe</p>
                    <ul class="travel-ul">
                        <li class="list">If you develop symptoms or test positive for COVID-19, self-isolate until you recover.</li>
                        <li class="list">Wear a properly fitted mask when physical distancing is not possible and in poorly ventilated settings.</li>
                        <li class="list">Keep physical distance of at least 1 metre from others, even if they don’t appear to be sick. Avoid crowds and close contact.</li>
                    </ul>
                </div>
                <div class="cnt-col2">
                    <p class="sub-title">What to do if you feel unwell</p>
                    <ul class="travel-ul">
                        <li class="list">If you have a fever, cough and difficulty breathing, seek medical attention immediately. Call by telephone first and follow the directions of your local health authority.</li>
                        <li class="list">Know the full range of symptoms of COVID-19. The most common symptoms of COVID-19 are fever, dry cough, tiredness and loss of taste or smell. Less common symptoms include aches and pains, headache, sore throat, red or irritated eyes, diarrhoea,  a skin rash or discolouration of fingers or toes.</li>
                        <li class="list">Stay home and self-isolate for 10 days from symptom onset, plus three days after symptoms cease. Call your health care provider or hotline for advice. Have someone bring you supplies. If you need to leave your house or have someone near you, wear a properly fitted mask to avoid infecting others</li>
                        <li class="list">Keep up to date on the latest information from trusted sources, such as WHO or your local and national health authorities. Local and national authorities and public health units are best placed to advise on what people in your area should be doing to protect themselves.</li>
                    </ul>
                </div>
            </div>
        </div>
